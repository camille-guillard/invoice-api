  ...
  describe('GET /api/invoices/revenue', () => {
    it('should calculate revenue for period', async () => {
      ...
      const response = await request(app).get(
        `/api/invoices/revenue?startDate=${currentYear}-01-01&endDate=${currentYear}-12-31`
      );
    ...
    it('should return 400 without startDate', async () => {
      const response = await request(app).get(`/api/invoices/revenue?endDate=${currentYear}-12-31`);
    ...
    it('should return 400 without endDate', async () => {
      const response = await request(app).get(`/api/invoices/revenue?startDate=${currentYear}-01-01`);
